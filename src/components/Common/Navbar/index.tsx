...
export const Navbar = () => {
    return(
        <nav className="h-16 w-full flex shadow-sm sticky items-center justify-between px-4">
            {/* Navigation Logo */}
            <div className="h-full w-fit flex items-center gap-4">
                ...
                <h1 className="text-xl font-semibold text-zinc-700">NoteFlow AI</h1>
            </div>
            ...
            <div className="h-full w-fit flex items-center gap-2">
                ...
                <button className="hidden lg:flex py-2 items-center justify-center px-2.5 border rounded-lg bg-blue-600/90 text-white font-semibold text-sm shrink-0">Try for free</button>
